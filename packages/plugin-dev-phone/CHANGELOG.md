...
- 2eddc7c: Show Timestmaps in SMS panel
...
- Updated dependencies [2eddc7c]
- Updated dependencies [7c4f338]
- Updated dependencies [9b3edac]
...
- 04bc90b: Adds debug console to bottom of Dev Phone UI with basic info about the current voice device status, including connection status and any errors. This is intended to help with debugging Dev Phone setup and connection issues without needing to check container logs.

### Patch Changes

- Updated dependencies [04bc90b]
  - @mqarty/dev-phone-ui@1.0.0-beta.31
...
- c4ddb9a: Adds debug console to bottom of Dev Phone UI with basic info about the current voice device status, including connection status and any errors. This is intended to help with debugging Dev Phone setup and connection issues without needing to check container logs.

### Patch Changes

- Updated dependencies [c4ddb9a]
  - @mqarty/dev-phone-ui@1.0.0-beta.29
...
- 08a3c09: Sub-header shows answer/decline icons with correct abilities.

### Patch Changes

- Updated dependencies [08a3c09]
  - @mqarty/dev-phone-ui@1.0.0-beta.27

## 1.0.0-beta.29

### Minor Changes

- 817bd70: Sub-header shows answer/decline icons with correct abilities.

### Patch Changes

- Updated dependencies [817bd70]
  - @mqarty/dev-phone-ui@1.0.0-beta.26
