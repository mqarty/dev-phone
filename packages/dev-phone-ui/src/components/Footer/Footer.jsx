...
function Footer() {
  return <Box marginTop={"space60"}>
    <Flex vertical hAlignContent={"center"}>
      ...
      <Paragraph>
        <Text fontSize={"fontSize20"}>
          For issues and contributions <Anchor href="https://github.com/mqarty/dev-phone" showExternal>check out our GitHub project</Anchor>. You can also <Anchor href="https://airtable.com/shrn1gZFT0uayIjgJ" showExternal>submit feedback via Airtable</Anchor>.
        </Text>
      </Paragraph>
    </Flex>
  </Box>
